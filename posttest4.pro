...
%Setelah eksekusi GOAL dijalanakan maka Prolog akan memulai pelacakan dari fakta CLAUSES pertama yaitu data orang-orang yang terlibat dalam kasus pembunuhan, dan korban pembunuhan yaitu siti yang dibunuh dengan pentungan. 
...
%Prolog akan memanggil fakta orang untuk mengetahui pembunuh. 
%Fakta pertama yang di dapat adalah budi. 
%Selanjutnya prolog akan memanggil fakta terbunuh dan didapat faktanya adalah siti. 
%Kemudian prolog akan mencari fakta dari dicurigai(X), dari fakta ini kemudian akan dilakukan proses pencarian pernyataan bersyarat dan sekali lagi prolog akan melakukan unifikasi terhadap pernyataan syarat-syarat tersebut. 
...
%Fakta yang di dapat adalah terbunuh_dengan( siti, pentungan ). 
...
%Lalu prolog akan memanggil fakta cara_kerja _mirip untuk mengetahui benda apa yang cara kerjanya mirip pentungan. 
%Fakta yang didapat adalah cara_kerja_mirip(kaki_palsu, pentungan). 
%Kemudian prolog akan mencari fakta dari kemungkinan_milik(X, Benda). 
