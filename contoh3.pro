...
%Date mengambil Bulan pada sistem komputer, dalam hal ini adalah Bulan Maret. Sehingga Maret diikatkan pada variabel Bulan_ini. Proses berhasil lalu lanjut subgoal berikutnya.
%Subgoal berikutnya yaitu daftar_telepon(Orang, _, Tanggal) didalam sub goal ini terdiri dari 1 data. Dilakukan pengecekkan unifikasi pada data yang telah ada. 
%Data pertama pada daftar_telepon adalah daftar_telepon(orang(kusdiar, prihatin), _, tanggal_lahir(3, mar, 1935)), maka orang(kusdiar, prihatin) diikatkan ke variabel Orang, dan tanggal_lahir diikatkan ke variabel Tanggal. Proses sukses dilaksanakan. Lalu lanjut ke subgoal berikutnya.
%Subgoal berikutnya yaitu cek_bulan_ulang_tahun(Bulan_ini, Tanggal). Bulan_ini telah diisi oleh Februari, dan Tanggal telah diisi oleh tanggal_lahir(3, mar, 1935), maka dilakukan pencocokan apakah cek_bulan_ulang_tahun(Maret, tanggal_lahir(3, mar, 1935)) hasil tidak cocok lalu dilakukan pencocokkan kembali data menggunakan lacakbalik dimulai dari subgoal berikutnya yaitu daftar_telepon(Orang, _, Tanggal) dengan unifikasi maka data teratas berikutnya akan dibaca.
%Terdapat predikat fail pada subgoal yang terakhir untuk memaksa lacak balik meski pun telah didapat solusi. 
%Karena tidak ditemukan solusi lain, maka hasil yang didapat hanya satu yang berulang tahun bulan ini yaitu kusidar prihatin.
